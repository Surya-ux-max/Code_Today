## React app build Command - npm create vite@latest Home

### npm - node package manager which is responsible in downloading of packages , dependencies , libraries . It is automatically downloaded with Node

### create - basic keyword which tells in creation of something new

### vite - It is most used frontend UI framework which is developed by Evan you , it is trusted by even OpenAI
